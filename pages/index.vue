<template>
    ...
    <div class="text-center font-bold font-serif pb-16">
        ...
        <div>
            <div class="flex w-36 ml-auto mr-auto mt-8">
                <img class="w-5 h-5 mt-8 mr-4" src="/asset/img/icons8-プログラマー-50.png" alt="プログラマー-50" />
            ...
            <ul class="pt-4 text-xl font-normal text-gray-600">
        ...
        <div>
            ...
            <ul class="text-xl pt-4 font-normal text-gray-600">
    ...
    <footer>
        <h1 class="h-16 pt-3 text-3xl text-bold bg-gray-600 text-white text-center font-bold font-serif">jun01t's Portfolio
        </h1>
    </footer>
</template>